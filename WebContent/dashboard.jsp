...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="horario.jsp">
      ...
      <div id="content">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle"
                  src="https://static.vecteezy.com/system/resources/previews/000/573/503/non_2x/vector-sign-of-user-icon.jpg">
              </a>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Mi sitio</h1>
          </div>
          <!-- Content Row -->
          <div class="row">
            <div class="col-xl-12 col-lg-2">
              <div class="card shadow mb-3">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tasas de deserción por semestres</h6> <a target="_blank" rel="nofollow"
                  href="https://www.mineducacion.gov.co/sistemasdeinformacion/1735/articles-254702_archivo_pdf_indicadores_permanencia.pdf">Mineducación</a>.
                </div>
                <!-- Card Body -->
                <div class="card-body">
