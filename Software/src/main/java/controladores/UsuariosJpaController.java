...
public class UsuariosJpaController implements Serializable {
    ...
    public UsuariosJpaController() {
        this.emf = Persistence.createEntityManagerFactory("com.mycompany_kol_war_1.0-SNAPSHOTPU");
    ...
    public Usuarios findUsuarios(Integer id) {
        ...
        try {
            Query query;
            query = em.createQuery("SELECT u FROM Usuarios u where u.usu like :Usu");
            query.setParameter("Usu", "luis1");

            List<Usuarios> tuplas = (List<Usuarios>) query.getResultList();
            System.out.println(tuplas.get(0).getContreseña());
    ...
    public Usuarios findUsuariosU(String Usu) {
        EntityManager em = getEntityManager();
        List<Usuarios> tuplas;
        ...
        try {
            ...
            System.out.println(Usu);
            tuplas = query.getResultList();
            transaction.commit();
            Usuarios a = tuplas.get(0);
            System.out.println(tuplas.get(0).getContreseña());
    ...
    public String[] comprobarPerfil(Usuarios aux) {
        String[] tipo = new String[3];

        tipo[0] = aux.getTipo();
        tipo[1] = aux.getUsu();
        tipo[2] = String.valueOf(aux.getIdUsu());
        return tipo;
