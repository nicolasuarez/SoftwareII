...
<head>
  ...
  <title>Usapp - Restablecer contraseña</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Pon tu nombre de usuario de USAPP, o la dirección de correo electrónico que usaste para registrarte. Te enviaremos un mensaje con tu nombre de usuario y un enlace para restablecer tu contraseña. </p>
                  </div>
                  <form class="user">
